...
public class Controller16 {
    ...
    public void method4(Model model, HttpSession session) {
        Object modelAttr1 = model.getAttribute("modelAttr1"); // sub3에서 만든객체 꺼낼 수 없음
        Object sessionAttr1 = session.getAttribute("sessionAttr1"); // sub3에서 만든객체 꺼낼 수 있음

        System.out.println("modelAttr1 = " + modelAttr1);   // Model객체는 요청마다 생김, 메소드마다 생김
        System.out.println("sessionAttr1 = " + sessionAttr1);   // session객체는 하나만
    }
