...
public class Controller39 {
    ...
    public ResponseEntity method1() {
        // ResponseEntity
        // : 응답코드와 응답본문 작성 가능한 객체
        // return type이 ResponseEntity면 @ResponseBody annotation은 써도 되고 안써도 된다.
...
//        return ResponseEntity.badRequest().build();
    ...
    @GetMapping("sub4")
    public ResponseEntity<MyDto45> method4(Integer id) { // ResponseEntity<> 의 type parameter는 본문의 타입결정
