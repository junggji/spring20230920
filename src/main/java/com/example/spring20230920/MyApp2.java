...
public class MyApp2 {
    public static void main(String[] args) {
        ...
        Object bean1 = context.getBean("myInstance2"); // spring이 만든 인스턴스를 spring bean이라고 한다.
        System.out.println(bean1 instanceof MyClass2); // true
        MyClass2 o1 = (MyClass2) bean1;
        o1.method2();

        Object bean3 = context.getBean("myBean3"); // spring이 만든 인스턴스를 spring bean이라고 한다.
        System.out.println(bean3 instanceof MyClass3); // true
        MyClass3 o3 = (MyClass3) bean3;

        // 같은 이름으로 꺼내면 항상 같은 객체이다.
