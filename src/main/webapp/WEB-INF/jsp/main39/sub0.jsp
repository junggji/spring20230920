        ...
        <script>
            function ajax1() {
                axios.get("/main39/sub1")
                    .then(() => console.log("성공"))  //  응답 성공시에(200번대)
                    .catch(() => console.log("실패")) //  응답 실패시에
            }
        </script>
    </div>
    ...
    <script>
        function ajax4() {
            axios.get("/main39/sub3")
                ...
                }); // 400 번대 응답이면 #result1 요소에 "잘못된 요청" 출력
...
<div>
    ...
    <script>
        function ajax7AddEmployee() {
            ...
            button1.setAttribute("disabled", "disabled"); // 클릭시 disabled(비활성화)
